...
class Student(Person):
    """
    Returns a ```Student``` object, takes a 3 arguments, name, branch, year.
...
class Teacher(Person):
    ...
    Returns a ```Teacher``` object, takes a list of strings (list of papers) as arguments.
...
student1 = Student("Rohan", "CSE", 2001)
teacher1 = Teacher("Tarique Sani", ['c', 'c++', 'php', 'python'])
